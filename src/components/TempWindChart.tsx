...
const TempWindChart: React.FC<TempWindChartProps> = ({ data, xAxisMode, onHoverDistance, weatherAvailable }) => (
    ...
    <ResponsiveContainer width="100%" height="100%">
      ...
      >
        ...
        <Line
          ...
          dot={(props: any) => {
            if (!props.payload.isSample) return null;
            return <circle key={props.index} cx={props.cx} cy={props.cy} r={4} fill="#9b59b6" stroke="white" strokeWidth={1.5} />;
          }}
          name="Wind"
          isAnimationActive={false}
        />
